...
d("PLAYER 1 : <br><br> Nom : " + iop.pseudo + "<br> Race : " + iop.race + "<br> Points de vie : " + iop.pdv + "<br> Attaque : " + iop.attaque + "<br> Level : " + iop.lvl + "<br> Arme : " + iop.arme + "<br> Sort : " + iop.sort + " (utilisable une seule fois)");
